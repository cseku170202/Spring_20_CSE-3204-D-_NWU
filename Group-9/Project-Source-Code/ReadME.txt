...
=>Create A database named tsms and t_shirt
=>import the Database.sql file into tsms and t_shirt database
--------------------------------------------------
--------------------------------------------------
///////////////Second Step///////////////////////
--------------------------------------------------
...
=>for open sourse code in pycharm goto file option then press open then select the tsms Sourse code folder
---------------------------------------------------
---------------------------------------------------
///////////////Third Step////////////////////////
--------------------------------------------------
...
for log in into Admin,User goto tsms and t_shirt database
and check login_admin,login for user id and password or open project admin_login,login and table.docs file 
and get user id and password
...
---------------------------------------------------
/		Nayan Sarkar			/
/	Email:nwu.sarkar126@gmail.com	        /			/
/		Moupia Mazumder Mou		/
/       Email:moupia2207@gmail.com         	/
/		Asmaul Husna Mony		/
/	Email:ahmoni440@gmail.com		/
