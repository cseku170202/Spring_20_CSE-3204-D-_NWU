...
=>Create  database named admin,db,dw,sregi,student_management_system
=>import the Database.sql file into those database
--------------------------------------------------
--------------------------------------------------
///////////////Second Step///////////////////////
--------------------------------------------------
...
mysql-db-backup-faster	0.1.0	0.2.0
mysqlclient	2.1.1	2.1.1
pip	22.0.4	22.2.2
protobuf	3.20.1	4.21.5
pyReturn	0.0.1	0.0.1
pytz	2022.1	2022.2.1
report	0.0.1	0.0.1
reportclassicproject	0.2	0.2
reportlab	3.6.11	3.6.11
requests	2.28.1	2.28.1
return-result	1.1.0	1.1.0
returnn	1.20220721.153911	1.20220810.141650
returns	0.19.0	0.19.0
setuptools	58.1.0	65.0.2
sqlparse	0.4.2	0.4.2
typing-extensions	4.3.0	4.3.0
tzdata	2022.1	2022.2
urllib3	1.26.11	1.26.11
win32-setctime	1.1.0	1.1.0
...
and get user name and password.(Admin and user Id:pranto,passowrd:11111(same for both)(if you want to change Id and Password you have to change from database)
