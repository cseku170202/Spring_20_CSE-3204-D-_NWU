...
def show_std():
    ...
    review_btn = Button(root, text="Submit", font="times 12 bold", bg="orchid", command=rsubmit)
    review_btn.grid(row=9, columnspan=2, column=3, ipadx=20, pady=20)
...
def show_tcr():
    ...
    mylabel = Label(root, image=bg)
    mylabel.place(x=200, y=100, relwidth=1, relheight=1)
    ...
    review_btn = Button(root, text="Submit", font="times 12 bold", bg="orchid", command=rsubmit)
    review_btn.grid(row=8, columnspan=2, column=3, ipadx=30, pady=20)
    ...
    print_record = ''
    for records in record:
        print_record += "Username: " + str(records[1])  + "\nExpected Salary: " + str(records[4]) + "\n" + "Address: " + str(records[5]) + "\n" + "Studies Information: " + str(records[6]) + "\n" + "Phone Number: " + str(records[7]) + "\n" + "Average Review: " + str(records[8]) + "\n"
        count += 1

    q_label = Label(root, text=print_record, font="timesnewroman 12")
    q_label.grid(row=2, column=2,padx=(200,0))
    q_label2 = Label(root, text="Total Teachers is this System: " + str(count), font="timesnewroman 12")
    q_label2.grid(row=3, column=2,padx=(200,0))
...
def homepage():
    ...
    querry_btn = Button(root, text="Find Teacher", bg="wheat", font="timesnewroman 12 ", pady=5, padx=5, borderwidth=5,command=showtcr)
    querry_btn.grid(row=4, column=1)
    querry_btn2 = Button(root, text="List of Student", bg="wheat", font="timesnewroman 12 ", pady=5, padx=5, borderwidth=5,
                         command=showstd)
    querry_btn2.grid(row=4, column=3)
    ...
    querry_btn3 = Button(root, text="Admin Login", bg="wheat", font="timesnewroman 12 ", pady=5, padx=5, borderwidth=5,
                         command=admin)
    querry_btn3.grid(row=8, column=1)
    querry_btn4 = Button(root, text="Student", bg="wheat", font="timesnewroman 12 ", pady=5, padx=5, borderwidth=5,
                         command=student)
    querry_btn4.grid(row=10, column=1,ipadx=15)
    querry_btn5 = Button(root, text="Teacher", bg="wheat", font="timesnewroman 12 ", pady=5, padx=5, borderwidth=5,
                         command=teacher)
